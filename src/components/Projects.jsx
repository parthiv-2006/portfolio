                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {projects.map((project, i) => (
                        <motion.div
                            ...
                            className="group relative rounded-2xl border border-border bg-surface/60 overflow-hidden cursor-pointer hover:border-border-hover transition-colors duration-300"
                        >
                            ...
                            <div className="p-5">
                                ...
                                <div className="flex flex-wrap gap-1.5">
                                    {project.tech.slice(0, 3).map((t) => (
                                        <span
                                            key={t}
                                            className="px-2 py-0.5 text-[11px] rounded-md bg-surface-light text-text-dim font-mono"
                                        >
                                            {t}
                                        </span>
                                    ))}
                                    {project.tech.length > 3 && (
                                        <span className="px-2 py-0.5 text-[11px] rounded-md bg-surface-light text-text-dim font-mono">
                                            +{project.tech.length - 3}
                                        </span>
                                    )}
                                </div>
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex flex-wrap gap-2 mb-6">
                                        {selected.tech.map((t) => (
                                            <span
                                                key={t}
                                                className="px-3 py-1 text-xs rounded-lg bg-surface-light text-text-muted font-mono border border-border"
                                            >
                                                {t}
                                            </span>
                                        ))}
                                    ...
                                    <div className="flex gap-3">
                                        <button className="flex items-center gap-2 px-4 py-2 rounded-xl bg-accent/10 text-accent text-sm font-medium border border-accent/20 hover:bg-accent/20 transition-colors">
                                            <Github size={16} /> Source
                                        </button>
                                        <button className="flex items-center gap-2 px-4 py-2 rounded-xl bg-surface-light text-text-muted text-sm font-medium border border-border hover:border-border-hover transition-colors">
