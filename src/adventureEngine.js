...
const ROOMS = {
    ...
    workshop: {
        ...
        description: [
            ...
            '> Five projects glow under spotlights, clearly the pride of this space.',
            '',
            '  Objects: leaseguard · angler · reflecta · palate · anima',
            '  Exits: lobby (west)',
        ],
        exits: { lobby: 'lobby' },
        objects: {
            leaseguard: [
                '> The "LeaseGuard" workbench is stacked with annotated lease PDFs.',
                '> A risk report renders on screen, every claim linked back to a statute.',
                '',
                '  📋 Stack: Next.js · TypeScript · Claude (MCP) · Supabase pgvector · RAG',
                '  🎯 Role: AI Agent · 2026',
                '',
                '  "An AI agent that reads Ontario leases through a 12-tool MCP server,',
                '   with hybrid BM25/vector retrieval over a 2,372-chunk legal corpus.',
                '   Grounded risk report in under 90 seconds. 206 tests."',
            ],
            angler: [
                '> The "Angler" bench is papered with competitor ad teardowns,',
                '> each one dissected into structured creative DNA.',
                '',
                '  📋 Stack: Next.js · TypeScript · Claude · Supabase · Apify · MCP',
                '  🎯 Role: AI Tool · 2026',
                '',
                '  "A four-module AI web app built solo in 10 days for the',
                '   ItsTodayMedia $5,000 Build Challenge. Mines competitor ads,',
                '   extracts patterns with a vision-language model, ships as an MCP server."',
            ],
            reflecta: [
                '> A terminal on the "Reflecta" bench scrolls green — tests generating,',
                '> failing, repairing themselves, and passing.',
                '',
                '  📋 Stack: Python · Typer · Gemini · Groq · Claude · pytest · AST',
                '  🎯 Role: Dev Tool · 2026',
                '',
                '  "A Python CLI agent published on PyPI that finds coverage gaps and',
                '   generates/repairs tests via multi-model routing.',
                '   Lifted coverage 64% → 80% on a real service. 338 tests."',
            ],
            palate: [
                '> A chaotic but brilliant setup — sticky notes, energy drinks, and a timer',
                '> frozen at 35:59:59. The UofTHacks 2026 submission station.',
                '',
                '  📋 Stack: Next.js · TypeScript · MongoDB · WebAuthn · Google Gemini',
                '  🎯 Role: Full-Stack · 2026',
                '',
                '  "Built the frontend and end-to-end passkey auth for a group-dining app',
                '   whose Gemini engine turns swipe data into restaurant picks.',
                '   Submitted against the 1Password challenge."',
            ],
            anima: [
                '> You approach the workbench labeled "Anima".',
                '> A gamified habit-tracking app hums on the screen — a virtual pet',
                '> that grows only as long as the streak holds.',
                '',
                '  📋 Stack: React · Vite · Zustand · Framer Motion · MongoDB',
                '  🎯 Role: Full-Stack · 2025',
                '',
                '  "Your Tamagotchi for productivity. Instead of checking boxes,',
                '   you keep a streak by caring for something that depends on it."',
            ],
        },
        item: {
            id: 'blueprint',
            ...
            found: false,
            hint: '> A rolled-up scroll peeks out from under the LeaseGuard workbench...',
            description: [
    ...
    library: {
        ...
        description: [
            ...
            '',
            '  Objects: degree · career · awards · certifications · saf-competition',
            '  Exits: lobby (east)',
        ],
        exits: { lobby: 'lobby' },
        objects: {
            degree: [
                ...
                '   Systems Programming, Computer Organization, Theory of Computation,',
                '   and Linear Algebra. CGPA: 3.6/4.0"',
            ],
            career: [
                ...
                '',
                '  ⚔ Applied Optimal — Full-Stack Dev, Contract  Jul 2026 – Sep 2026',
                '     "Trial-to-paid subscriptions with Stripe. 130 automated tests."',
                '',
                '  ⚔ GenLedge — Software Developer, Contract     Mar 2026 – May 2026',
                '     "A 12-tool Stripe MCP server for AI accounting agents."',
                '',
                '  ⚔ Outamation — AI & Automation Extern         May 2025 – Aug 2025',
                '     "NLP and OCR pipelines. Tuned a RAG system, +25% relevance."',
                '',
                '  ⚔ Chester-Hill — Software QA Tester, Intern   Jun 2024 – Nov 2024',
                '     "Automated tests across 50+ user flows."',
                '',
    ...
    forge: {
        ...
        description: [
            ...
            '',
            '  Objects: languages · frameworks · databases · devtools · ai',
        ...
        objects: {
            ...
            frameworks: [
                ...
                '  🔨 FastAPI           ★ core   — Python services that hold up',
                '  🔨 Node.js / Express          — server-side backbone',
                '  🔨 Flutter                    — one codebase, every screen',
                '  🔨 Tailwind CSS               — rapid styling',
                '  🔨 Redux / Zustand            — state management',
                '  🔨 LlamaIndex                 — retrieval plumbing',
            ],
            databases: [
                '> Crystalline data structures float in suspension:',
                '',
                '  💎 PostgreSQL  ★ core   — relational powerhouse',
                '  💎 Supabase    ★ core   — Postgres with pgvector for RAG',
            ...
            devtools: [
                ...
                '  🔧 OAuth 2.0 / OIDC          — Zitadel and friends',
                '  🔧 WebAuthn                  — passkey implementations',
                '  🔧 REST APIs & Jira          — architecture and workflow',
            ],
            ai: [
                '> A rack of newer instruments hums with a different kind of heat:',
                '',
                '  🤖 Claude Code / Claude API  ★ core   — daily driver',
                '  🤖 Model Context Protocol    ★ core   — 3 MCP servers shipped',
                '  🤖 RAG                       ★ core   — hybrid BM25 + vector retrieval',
                '  🤖 Google Gemini                      — generation and vision',
                '  🤖 Cursor / Codex                     — pair programming',
            ],
        },
        item: {
            id: 'hammer',
