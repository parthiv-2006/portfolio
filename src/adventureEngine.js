...
const ROOMS = {
    ...
    library: {
        ...
        description: [
            ...
            '',
            '  Objects: degree · deans-list · hackathon',
            '  Exits: lobby (east)',
        ],
        exits: { lobby: 'lobby' },
        objects: {
            degree: [
                ...
                '     2024 – Present',
                '',
                '  "Advanced coursework in algorithms, systems programming,',
                '   and software engineering."',
            ],
            'deans-list': [
                '> A gilded certificate on the wall catches your eye:',
                '',
                '  🏅 Dean\'s List Scholar — 2024-2025',
                '     "Recognized for academic excellence in the',
                '      Computer Science Specialist program."',
            ],
            hackathon: [
                '> A photo on the desk shows a team celebrating at UofTHacks.',
                '',
                '  🏆 UofTHacks Participant — 2024',
                '     "Designed and developed an innovative solution in 36 hours.',
                '      Collaborated under extreme time pressure with a cross-functional team."',
            ],
        },
        item: {
            id: 'quill',
    ...
    forge: {
        ...
        objects: {
            languages: [
                '> You examine the language rack. Five instruments gleam:',
                '',
                '  ⚡ Python      ★ core    — the first language, learned at 14',
            ...
            frameworks: [
                ...
                '',
                '  🔨 React       ★ core   — UI architecture of choice',
                '  🔨 Node.js     ★ core   — server-side backbone',
                '  🔨 Express     ★ core   — lean API layer',
                '  🔨 Next.js              — SSR when needed',
            ],
            databases: [
